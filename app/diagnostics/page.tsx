...
const diagnostics = [
  ...
  },
  {
    ...
    description: "Home sleep studies and pulmonary function testing.",
  ...
  },
  {
    ...
    description: "Specialized testing rarely in-house anywhere else.",
    to: "/diagnostics/autonomic-testing",
    badge: "Rare",
  },
  {
    title: "Cancer Screening & Radiology",
    description: "Coordinated preventive screening across modalities.",
    to: "/diagnostics/cancer-screening",
  },
  {
    title: "Allergy Testing",
    description: "Comprehensive skin and lab-based allergy panels.",
